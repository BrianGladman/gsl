...
int gsl_sort_vector_ushort_smallest (unsigned short * dest, size_t k, const gsl_vector_ushort * v);
int gsl_sort_vector_ushort_largest (unsigned short * dest, size_t k, const gsl_vector_ushort * v);
