...
INLINE_DECL void    gsl_matrix_char_inc(gsl_matrix_char * m, const size_t i, const size_t j, const char x);
...
INLINE_FUN 
void
gsl_matrix_char_inc(gsl_matrix_char * m, const size_t i, const size_t j, const char x)
{
#if GSL_RANGE_CHECK
  if (GSL_RANGE_COND(1)) 
    {
