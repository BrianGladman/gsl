...
INLINE_DECL void    gsl_matrix_float_inc(gsl_matrix_float * m, const size_t i, const size_t j, const float x);
...
INLINE_FUN 
void
gsl_matrix_float_inc(gsl_matrix_float * m, const size_t i, const size_t j, const float x)
{
#if GSL_RANGE_CHECK
  if (GSL_RANGE_COND(1)) 
    {
