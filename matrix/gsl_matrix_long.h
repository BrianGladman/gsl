...
gsl_matrix_long gsl_matrix_long_submatrix (gsl_matrix_long * m, const size_t i, const size_t j, const size_t n1, const size_t n2);
...
const gsl_vector_long gsl_matrix_long_const_column (const gsl_matrix_long * m, const size_t j);
