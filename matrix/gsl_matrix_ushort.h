...
INLINE_DECL void    gsl_matrix_ushort_inc(gsl_matrix_ushort * m, const size_t i, const size_t j, const unsigned short x);
...
INLINE_FUN 
void
gsl_matrix_ushort_inc(gsl_matrix_ushort * m, const size_t i, const size_t j, const unsigned short x)
{
#if GSL_RANGE_CHECK
  if (GSL_RANGE_COND(1)) 
    {
