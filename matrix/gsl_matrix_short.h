...
int gsl_matrix_short_copy_row(gsl_vector_short * v, const gsl_matrix_short * m, size_t i);
int gsl_matrix_short_copy_col(gsl_vector_short * v, const gsl_matrix_short * m, size_t j);
...
int gsl_matrix_short_copy(gsl_matrix_short * dest, const gsl_matrix_short * src);

int gsl_vector_short_view_rol_from_matrix (gsl_vector_short * v, gsl_matrix_short * m, size_t i);
