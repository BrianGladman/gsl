...
INLINE_DECL void    gsl_matrix_inc(gsl_matrix * m, const size_t i, const size_t j, const double x);
...
INLINE_FUN 
void
gsl_matrix_inc(gsl_matrix * m, const size_t i, const size_t j, const double x)
{
#if GSL_RANGE_CHECK
  if (GSL_RANGE_COND(1)) 
    {
