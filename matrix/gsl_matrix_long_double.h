...
int gsl_matrix_long_double_view_from_matrix (gsl_matrix_long_double * m, 
                                       gsl_matrix_long_double * mm,
                                       const size_t k1,
                                       const size_t k2,
                                       const size_t n1, 
                                       const size_t n2);
...
int gsl_matrix_long_double_view_from_array (gsl_matrix_long_double * m, 
                                      long double * base,
                                      const size_t offset,
                                      const size_t n1, 
                                      const size_t n2);

gsl_matrix_long_double gsl_matrix_long_double_view (long double * m, 
                                        const size_t n1, 
                                        const size_t n2);

int gsl_vector_long_double_view_row_from_matrix (gsl_vector_long_double * v, gsl_matrix_long_double * m, const size_t i);
...
int gsl_matrix_long_double_swap(gsl_matrix_long_double * m1, const gsl_matrix_long_double * m2);
...
gsl_matrix_long_double gsl_matrix_long_double_submatrix (gsl_matrix_long_double * m, size_t i, size_t j, size_t n1, size_t n2);
gsl_vector_long_double gsl_matrix_long_double_row (gsl_matrix_long_double * m, size_t i);
...
const gsl_matrix_long_double gsl_matrix_long_double_const_submatrix (const gsl_matrix_long_double * m, size_t i, size_t j, size_t n1, size_t n2);
const gsl_vector_long_double gsl_matrix_long_double_const_row (const gsl_matrix_long_double * m, size_t i);
const gsl_vector_long_double gsl_matrix_long_double_const_column (const gsl_matrix_long_double * m, size_t j);
const gsl_vector_long_double gsl_matrix_long_double_const_diagonal (const gsl_matrix_long_double * m);
