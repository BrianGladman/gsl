...
int gsl_matrix_long_double_tricpy(const char uplo_dest, const char uplo_src, const int copy_diag, gsl_matrix_long_double * dest, const gsl_matrix_long_double * src);
