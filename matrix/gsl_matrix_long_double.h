...
gsl_matrix_long_double gsl_matrix_long_double_submatrix (gsl_matrix_long_double * m, const size_t i, const size_t j, const size_t n1, const size_t n2);
...
const gsl_vector_long_double gsl_matrix_long_double_const_column (const gsl_matrix_long_double * m, const size_t j);
