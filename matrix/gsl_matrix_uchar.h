...
int gsl_matrix_uchar_view_from_matrix (gsl_matrix_uchar * m, 
                                       gsl_matrix_uchar * mm,
                                       const size_t k1,
                                       const size_t k2,
                                       const size_t n1, 
...
int gsl_matrix_uchar_view_from_vector (gsl_matrix_uchar * m, 
                                       gsl_vector_uchar * v,
                                       const size_t offset,
                                       const size_t n1, 
                                       const size_t n2);
...
int gsl_matrix_uchar_view_from_array (gsl_matrix_uchar * m, 
                                      unsigned char * base,
                                      const size_t offset,
                                      const size_t n1, 
                                      const size_t n2);

gsl_matrix_uchar gsl_matrix_uchar_view (unsigned char * m, 
                                        const size_t n1, 
                                        const size_t n2);
...
int gsl_matrix_uchar_swap(gsl_matrix_uchar * m1, const gsl_matrix_uchar * m2);
...
const gsl_matrix_uchar gsl_matrix_uchar_const_submatrix (const gsl_matrix_uchar * m, size_t i, size_t j, size_t n1, size_t n2);
const gsl_vector_uchar gsl_matrix_uchar_const_row (const gsl_matrix_uchar * m, size_t i);
const gsl_vector_uchar gsl_matrix_uchar_const_column (const gsl_matrix_uchar * m, size_t j);
const gsl_vector_uchar gsl_matrix_uchar_const_diagonal (const gsl_matrix_uchar * m);
