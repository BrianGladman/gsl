...
INLINE_DECL void    gsl_matrix_uchar_inc(gsl_matrix_uchar * m, const size_t i, const size_t j, const unsigned char x);
...
INLINE_FUN 
void
gsl_matrix_uchar_inc(gsl_matrix_uchar * m, const size_t i, const size_t j, const unsigned char x)
{
#if GSL_RANGE_CHECK
  if (GSL_RANGE_COND(1)) 
    {
