...
Before compiling the project you need to check that
the directory where you installed GSL is present in
the Microsoft Visual Studio include and library
paths.  The directory is added automatically to
these paths if you install the library with the
automated setup program.
...
With these settings you should be able to compile
and link the program main.c in this directory.
...
If you see the same output, congratulations -- the
library is working.
