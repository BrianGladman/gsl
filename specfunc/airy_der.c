...
static struct gsl_sf_ChebSeries aip2_cs = {
  aip2_data,
  14,
  -1, 1,
  (double *)0,
...
static struct gsl_sf_ChebSeries aip1_cs = {
  aip1_data,
  24,
  -1, 1,
  (double *)0,
...
static struct gsl_sf_ChebSeries bip1_cs = {
  bip1_data,
  23,
  -1, 1,
  (double *) 0,
...
static struct gsl_sf_ChebSeries an22_cs = {
  an22_data,
  32,
  -1, 1,
  (double *) 0,
...
static struct gsl_sf_ChebSeries an21_cs = {
  an21_data,
  23,
  -1, 1,
  (double *) 0,
...
static struct gsl_sf_ChebSeries an20_cs = {
  an20_data,
  15,
  -1, 1,
  (double *)0,
...
static struct gsl_sf_ChebSeries aph2_cs = {
  aph2_data,
  31,
  -1, 1,
  (double *)0,
...
static struct gsl_sf_ChebSeries aph1_cs = {
  aph1_data,
  21,
  -1, 1,
  (double *)0,
...
static struct gsl_sf_ChebSeries aph0_cs = {
  aph0_data,
  14,
  -1, 1,
  (double *)0,
