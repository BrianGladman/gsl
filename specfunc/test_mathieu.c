...
int test_mathieu(void)
{
  ...
  TEST_SF(s, gsl_sf_mathieu_c, (0, 0.0, M_PI_2, &r),
          0.7071067811865475, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (0, 5.0, 0.0, &r),
          0.04480018165188902, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (0, 5.0, M_PI_2, &r),
          1.334848674698019, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (0, 10.0, 0.0, &r),
          0.007626517570935782, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (0, 10.0, M_PI_2, &r),
          1.468660470712856, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (0, 15.0, 0.0, &r),
          0.001932508315204592, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (0, 15.0, M_PI_2, &r),
          1.550108146686649, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (0, 20.0, 0.0, &r),
          0.0006037438292242197, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (0, 20.0, M_PI_2, &r),
          1.609890857395926, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (0, 25.0, 0.0, &r),
          0.0002158630184146612, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (0, 25.0, M_PI_2, &r),
          1.657510298323475, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (1, 0.0, 0.0, &r),
          1.00000000, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (1, 5.0, 0.0, &r),
          0.2565428793223637, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (1, 10.0, 0.0, &r),
          0.05359874774717657, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (1, 15.0, 0.0, &r),
          0.01504006645382623, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (1, 20.0, 0.0, &r),
          0.005051813764712904, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (1, 25.0, 0.0, &r),
          0.001911051506657645, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (1, 0.0, M_PI_2, &r),
          1.0000000, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (1, 5.0, M_PI_2, &r),
          1.337433887022345, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (1, 10.0, M_PI_2, &r),
          1.468755664102938, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (1, 15.0, M_PI_2, &r),
          1.550115074357552, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (1, 20.0, M_PI_2, &r),
          1.609891592603772, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (1, 25.0, M_PI_2, &r),
          1.657510398374516, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 0.0, 0.0, &r),
          1.00000000, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 0.0, M_PI_2, &r),
          -1.00000000, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 5.0, 0.0, &r),
          0.7352943084006845, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 5.0, M_PI_2, &r),
          -0.7244881519676682, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 10.0, 0.0, &r),
          0.2458883492913189, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 10.0, M_PI_2, &r),
          -0.9267592641263211, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 15.0, 0.0, &r),
          0.07879282784639313, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 15.0, M_PI_2, &r),
          -1.019966226030262, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 20.0, 0.0, &r),
          0.02864894314707431, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 20.0, M_PI_2, &r),
          -1.075293228779687, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 25.0, 0.0, &r),
          0.0115128663308875, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (2, 25.0, M_PI_2, &r),
          -1.116278953295253, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (5, 0.0, 0.0, &r),
          1.00000000, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (5, 5.0, 0.0, &r),
          1.12480725063848, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (5, 10.0, 0.0, &r),
          1.258019941308287, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (5, 15.0, 0.0, &r),
          1.193432230413072, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (5, 20.0, 0.0, &r),
          0.9365755314226215, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (5, 25.0, 0.0, &r),
          0.6106943100506986, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (5, 0.0, M_PI_2, &r),
          1.0000000, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (5, 5.0, M_PI_2, &r),
          0.9060779302023551, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (5, 10.0, M_PI_2, &r),
          0.8460384335355106, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (5, 15.0, M_PI_2, &r),
          0.837949340012484, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (5, 20.0, M_PI_2, &r),
          0.8635431218533667, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (5, 25.0, M_PI_2, &r),
          0.8992683245108413, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 0.0, 0.0, &r),
          1.00000000, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 0.0, M_PI_2, &r),
          -1.00000000, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 5.0, 0.0, &r),
          1.025995027089438, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 5.0, M_PI_2, &r),
          -0.975347487235964, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 10.0, 0.0, &r),
          1.053815992100935, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 10.0, M_PI_2, &r),
          -0.9516453181789554, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 15.0, 0.0, &r),
          1.084106311839221, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 15.0, M_PI_2, &r),
          -0.9285480638845388, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 20.0, 0.0, &r),
          1.117788631259397, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 20.0, M_PI_2, &r),
          -0.9057107845940974, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 25.0, 0.0, &r),
          1.156239918632239, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (10, 25.0, M_PI_2, &r),
          -0.8826919105636903, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (15, 0.0, 0.0, &r),
          1.00000000, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (15, 5.0, 0.0, &r),
          1.011293732529566, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (15, 10.0, 0.0, &r),
          1.022878282438181, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (15, 15.0, 0.0, &r),
          1.034793652236873, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (15, 20.0, 0.0, &r),
          1.047084344162887, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_c, (15, 25.0, 0.0, &r),
          1.059800441813937, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (15, 0.0, M_PI_2, &r),
          -1.0000000, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (15, 5.0, M_PI_2, &r),
          -0.9889607027406357, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (15, 10.0, M_PI_2, &r),
          -0.9781423471832157, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (15, 15.0, M_PI_2, &r),
          -0.9675137031854538, TEST_SNGL, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_mathieu_s, (15, 20.0, M_PI_2, &r),
