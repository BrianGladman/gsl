...
int test_airy(void)
{
  ...
  TEST_SF(s, gsl_sf_airy_Ai_e, (-500.0, m, &r),              0.0725901201040411396,  TEST_TOL0, GSL_SUCCESS);
  ...
  TEST_SF(s, gsl_sf_airy_Ai_e, (3.499999999999987, m, &r),   0.002584098786989702,  TEST_TOL0, GSL_SUCCESS);
  ...
  TEST_SF(s, gsl_sf_airy_Bi_e, (-500.0, m, &r),	            -0.094688570132991028, TEST_TOL0, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_airy_Bi_e, (-5.0, m, &r),	            -0.1383691349016005,   TEST_TOL0, GSL_SUCCESS);
  ...
  TEST_SF(s, gsl_sf_airy_Bi_e, (3.499999999999987, m, &r),   33.05550675461069,    TEST_TOL0, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_airy_Bi_e, (5.39999999999998, m, &r),    1604.476078241272,    TEST_TOL0, GSL_SUCCESS);

  TEST_SF(s, gsl_sf_airy_Bi_scaled_e, (-5.0, m, &r),	           -0.1383691349016005,  TEST_TOL0, GSL_SUCCESS);
  ...
  TEST_SF(s, gsl_sf_airy_Bi_scaled_e, (3.499999999999987, m, &r),   0.4201771882353061,	 TEST_TOL0, GSL_SUCCESS);
  TEST_SF(s, gsl_sf_airy_Bi_scaled_e, (5.39999999999998, m, &r),    0.3734050675720473,	 TEST_TOL0, GSL_SUCCESS);


  /** derivatives */

  TEST_SF(s, gsl_sf_airy_Ai_deriv_e, (-5.0, m, &r),	            0.3271928185544435,    TEST_TOL0, GSL_SUCCESS);
  ...
  TEST_SF(s, gsl_sf_airy_Ai_deriv_scaled_e, (-5.0, m, &r),		  0.3271928185544435, TEST_TOL0, GSL_SUCCESS);
