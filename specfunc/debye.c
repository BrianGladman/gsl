...
static struct gsl_sf_ChebSeries adeb1_cs = {
  adeb1_data,
  18,
  -1.0, 1.0,
  (double *)0,
...
static struct gsl_sf_ChebSeries adeb2_cs = {
  adeb2_data,
  18,
  -1.0, 1.0,
  (double *)0,
...
static struct gsl_sf_ChebSeries adeb3_cs = {
  adeb3_data,
  18,
  -1.0, 1.0,
  (double *)0,
...
static struct gsl_sf_ChebSeries adeb4_cs = {
  adeb4_data,
  18,
  -1.0, 1.0,
  (double *)0,
