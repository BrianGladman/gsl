...
int gsl_block_long_fread_with_stride (FILE * stream, long * b, size_t n, size_t stride);
int gsl_block_long_fwrite_with_stride (FILE * stream, const long * b, size_t n, size_t stride);
int gsl_block_long_fscanf_with_stride (FILE * stream, long * b, size_t n, size_t stride);
int gsl_block_long_fprintf_with_stride (FILE * stream, const long * b, size_t n, size_t stride, const char *format);
