#ifndef GSL_BLOCK_FLOAT_H
#define GSL_BLOCK_FLOAT_H
...
int gsl_block_float_fread_with_stride (FILE * stream, float * b, size_t n, size_t stride);
int gsl_block_float_fwrite_with_stride (FILE * stream, const float * b, size_t n, size_t stride);
int gsl_block_float_fscanf_with_stride (FILE * stream, float * b, size_t n, size_t stride);
int gsl_block_float_fprintf_with_stride (FILE * stream, const float * b, size_t n, size_t stride, const char *format);

size_t gsl_block_float_size (const gsl_block_float * b);
float * gsl_block_float_data (const gsl_block_float * b);

#endif /* GSL_BLOCK_FLOAT_H */
