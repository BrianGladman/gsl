#ifndef GSL_BLOCK_LONG_DOUBLE_H
#define GSL_BLOCK_LONG_DOUBLE_H
...
int gsl_block_long_double_fread_with_stride (FILE * stream, long double * b, size_t n, size_t stride);
int gsl_block_long_double_fwrite_with_stride (FILE * stream, const long double * b, size_t n, size_t stride);
int gsl_block_long_double_fscanf_with_stride (FILE * stream, long double * b, size_t n, size_t stride);
int gsl_block_long_double_fprintf_with_stride (FILE * stream, const long double * b, size_t n, size_t stride, const char *format);
