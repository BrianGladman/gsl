                     ...
                     gsl_vector_float * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_strmv(ord, Uplo, TransA, Diag,
                       row_dim,
		       A->data, col_dim,
		       X->data, X->stride
		       );
                     ...
                     gsl_vector * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_dtrmv(ord, Uplo, TransA, Diag,
                       row_dim,
		       A->data, col_dim,
		       X->data, X->stride
		       );
                     ...
                     gsl_vector_complex * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_ctrmv(ord, Uplo, TransA, Diag,
                       row_dim,
		       A->data, col_dim,
		       X->data, X->stride
		       );
                     ...
                     gsl_vector_complex * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_ztrmv(ord, Uplo, TransA, Diag,
                       row_dim,
		       A->data, col_dim,
		       X->data, X->stride
		       );
                     ...
                     gsl_vector_float * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_stbmv(ord, Uplo, TransA, Diag,
                       row_dim,
		       K,
		       A->data, col_dim,
		       X->data, X->stride
                     ...
                     gsl_vector * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_dtbmv(ord, Uplo, TransA, Diag,
                       row_dim,
		       K,
		       A->data, col_dim,
		       X->data, X->stride
                     ...
                     gsl_vector_complex * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_ctbmv(ord, Uplo, TransA, Diag,
                       row_dim,
		       K,
		       A->data, col_dim,
		       X->data, X->stride
                     ...
                     gsl_vector_complex * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_ztbmv(ord, Uplo, TransA, Diag,
                       row_dim,
		       K,
		       A->data, col_dim,
		       X->data, X->stride
                     ...
                     gsl_vector_float * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_strsv(ord, Uplo, TransA, Diag,
                       row_dim,
		       A->data, col_dim,
		       X->data, X->stride
		       );
                     ...
                     gsl_vector * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_dtrsv(ord, Uplo, TransA, Diag,
                       row_dim,
		       A->data, col_dim,
		       X->data, X->stride
		       );
                     ...
                     gsl_vector_complex * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_ctrsv(ord, Uplo, TransA, Diag,
                       row_dim,
		       A->data, col_dim,
		       X->data, X->stride
		       );
                     ...
                     gsl_vector_complex *X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_ztrsv(ord, Uplo, TransA, Diag,
                       row_dim,
		       A->data, col_dim,
		       X->data, X->stride
		       );
                     ...
                     gsl_vector_float * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_stbsv(ord, Uplo, TransA, Diag,
                       row_dim,
		       K,
		       A->data, col_dim,
		       X->data, X->stride
                     ...
                     gsl_vector * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_dtbsv(ord, Uplo, TransA, Diag,
                       row_dim,
		       K,
		       A->data, col_dim,
		       X->data, X->stride
                     ...
                     gsl_vector_complex * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_ctbsv(ord, Uplo, TransA, Diag,
                       row_dim,
		       K,
		       A->data, col_dim,
		       X->data, X->stride
                     ...
                     gsl_vector_complex * X)
{
  ...
  if(col_dim == X->size) {
    gsl_blas_raw_ztbsv(ord, Uplo, TransA, Diag,
                       row_dim,
		       K,
		       A->data, col_dim,
		       X->data, X->stride
                    ...
                    gsl_matrix_float * A)
{
  ...
  gsl_blas_raw_sger(ord, row_dim, col_dim,
		    alpha,
        	    X->data, X->stride,
        	    Y->data, Y->stride,
        	    A->data, col_dim
                    ...
                    gsl_matrix * A)
{
  ...
  gsl_blas_raw_dger(ord, row_dim, col_dim,
		    alpha,
        	    X->data, X->stride,
        	    Y->data, Y->stride,
        	    A->data, col_dim
