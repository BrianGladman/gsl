 ...
 */
int  gsl_blas_snrm2  (const gsl_vector_float * X, float * result)
{
  *result = gsl_blas_raw_snrm2(X->size, X->data, X->stride);
  return GSL_SUCCESS;
}

int  gsl_blas_sasum  (const gsl_vector_float * X, float * result)
{
  *result = gsl_blas_raw_sasum(X->size, X->data, X->stride);
  return GSL_SUCCESS;
}

int gsl_blas_dnrm2  (const gsl_vector * X, double * result)
{
  *result = gsl_blas_raw_dnrm2(X->size, X->data, X->stride);
  return GSL_SUCCESS;
}

int gsl_blas_dasum  (const gsl_vector * X, double * result)
{
  *result = gsl_blas_raw_dasum(X->size, X->data, X->stride);
  return GSL_SUCCESS;
}

int  gsl_blas_scnrm2 (const gsl_vector_complex * X, float * result)
{
}

int  gsl_blas_scasum (const gsl_vector_complex * X, float * result)
{
}

int gsl_blas_dznrm2 (const gsl_vector_complex * X, double * result)
{
}

int gsl_blas_dzasum (const gsl_vector_complex * X, double * result)
{
}
