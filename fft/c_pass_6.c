		    ...
		    const gsl_complex twiddle5[])
{
  ...
  for (k = 0; k < q; k++)
      ...
      for (k1 = 0; k1 < p_1; k1++)
	{
	  ...
	  /* ta2 = z0 - ta1/2 */
	  const double ta2_real = z0_real - ta1_real / 2;
	  const double ta2_imag = z0_imag - ta1_imag / 2;
	  ...
	  /* tb2 = z3 - tb1/2 */
	  const double tb2_real = z3_real - tb1_real / 2;
	  const double tb2_imag = z3_imag - tb1_imag / 2;
