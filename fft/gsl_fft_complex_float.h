...
gsl_fft_complex_float_wavetable;
...
gsl_fft_complex_float_forward (float data[], 
			       size_t stride, 
			       size_t n,
			       const gsl_fft_complex_float_wavetable * wavetable);
...
gsl_fft_complex_float_init (size_t n,
			    gsl_fft_complex_float_wavetable * wavetable);

int
gsl_fft_complex_float_generate_wavetable (size_t n,
					  gsl_fft_complex_float_wavetable * wavetable);

gsl_fft_complex_float_wavetable * gsl_fft_complex_float_wavetable_alloc (size_t n);

void
gsl_fft_complex_float_wavetable_free (gsl_fft_complex_float_wavetable * wavetable);

int
gsl_fft_complex_float_wavetable_cpy (gsl_fft_complex_float_wavetable * dest,
				     gsl_fft_complex_float_wavetable * src) ;
