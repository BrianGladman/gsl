...
void gsl_vector_ulong_set(gsl_vector_ulong * v, const size_t i, const unsigned long x);
...
extern inline 
void
gsl_vector_ulong_set(gsl_vector_ulong * v, const size_t i, const unsigned long x)
{
#ifndef GSL_RANGE_CHECK_OFF
  if (i >= v->size) /* size_t is unsigned, can't be negative */
    {
