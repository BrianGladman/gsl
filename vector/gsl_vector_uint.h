...
INLINE_DECL void gsl_vector_uint_inc (gsl_vector_uint * v, const size_t i, const unsigned int x);
...
INLINE_FUN
void
gsl_vector_uint_inc (gsl_vector_uint * v, const size_t i, const unsigned int x)
{
#if GSL_RANGE_CHECK
  if (GSL_RANGE_COND(i >= v->size))
    {
