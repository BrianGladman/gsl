...
INLINE_DECL void gsl_vector_uchar_inc (gsl_vector_uchar * v, const size_t i, const unsigned char x);
...
INLINE_FUN
void
gsl_vector_uchar_inc (gsl_vector_uchar * v, const size_t i, const unsigned char x)
{
#if GSL_RANGE_CHECK
  if (GSL_RANGE_COND(i >= v->size))
    {
