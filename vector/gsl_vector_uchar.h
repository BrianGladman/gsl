...
void gsl_vector_uchar_set(gsl_vector_uchar * v, const size_t i, const unsigned char x);
...
extern inline 
void
gsl_vector_uchar_set(gsl_vector_uchar * v, const size_t i, const unsigned char x)
{
#ifndef GSL_RANGE_CHECK_OFF
  if (i >= v->size) /* size_t is unsigned, can't be negative */
    {
