...
int gsl_vector_ushort_mul_elements (gsl_vector_ushort * a, const gsl_vector_ushort * b);
int gsl_vector_ushort_div_elements (gsl_vector_ushort * a, const gsl_vector_ushort * b);
