...
struct gsl_vector_ushort_struct
{
  size_t size;
  size_t stride;
  struct gsl_matrix_ushort_struct * parent;
  unsigned short *data;
};
...
int gsl_block_ushort_fread (FILE * stream, unsigned short *data, size_t n, size_t stride);
int gsl_block_ushort_fwrite (FILE * stream, const unsigned short *data, size_t n, size_t stride);
int gsl_block_ushort_fscanf (FILE * stream, unsigned short *data, size_t n, size_t stride);
int gsl_block_ushort_fprintf (FILE * stream, const unsigned short *data, size_t n, size_t stride,
			      const char *format);
