...
gsl_complex_float * gsl_vector_complex_float_getp(const gsl_vector_complex_float * v, size_t i);
void gsl_vector_complex_float_set(gsl_vector_complex_float * v, size_t i, const gsl_complex_float * x);
...
extern inline 
void
gsl_vector_complex_float_set(gsl_vector_complex_float * v, const size_t i, const gsl_complex_float * x)
{
#ifndef GSL_RANGE_CHECK_OFF
  if (i >= v->size) /* size_t is unsigned, can't be negative */
    {
