...
%%CreationDate: Wed Sep 16 14:59:41 1998
%%DocumentFonts: 
...
\put(3137,2013){\rjust{$p=0.5,n=3$}}
\put(2000,2276){\cjust{Negative Binomial Distribution}}
\put(2000,150){\cjust{$k$ (k covers the range $[k,k+1]$)}}
\put(100,1263){%
...
\put(3550,300){\cjust{10}}
\put(3240,300){\cjust{9}}
\put(2930,300){\cjust{8}}
\put(2620,300){\cjust{7}}
\put(2310,300){\cjust{6}}
\put(2000,300){\cjust{5}}
\put(1690,300){\cjust{4}}
\put(1380,300){\cjust{3}}
\put(1070,300){\cjust{2}}
\put(760,300){\cjust{1}}
\put(450,300){\cjust{0}}
\put(400,2126){\rjust{0.3}}
\put(400,1551){\rjust{0.2}}
\put(400,975){\rjust{0.1}}
\put(400,400){\rjust{0}}
\endGNUPLOTpicture
