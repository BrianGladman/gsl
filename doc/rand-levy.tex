...
\put(3137,1913){\rjust{$\mu=1, a=2.0$}}
\put(3137,2013){\rjust{$\mu=1, a=1.0$}}
\put(2000,2276){\cjust{Levy Distribution}}
...
\put(760,300){\cjust{-4}}
\put(450,300){\cjust{-5}}
\put(400,1934){\rjust{0.4}}
\put(400,1551){\rjust{0.3}}
\put(400,1167){\rjust{0.2}}
\put(400,784){\rjust{0.1}}
\put(400,400){\rjust{0}}
\endGNUPLOTpicture
