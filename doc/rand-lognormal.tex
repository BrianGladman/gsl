...
\put(3087,1963){\rjust{$\zeta=1, \sigma=1$}}
\put(3087,2063){\rjust{$\zeta=0, \sigma=1$}}
\put(1925,2276){\cjust{Lognormal Distribution}}
...
\put(3500,200){\cjust{3}}
\put(2450,200){\cjust{2}}
\put(1400,200){\cjust{1}}
\put(350,200){\cjust{0}}
