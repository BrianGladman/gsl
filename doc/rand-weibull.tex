...
%%CreationDate: Sat Sep 12 13:27:01 1998
%%DocumentFonts: 
...
\put(3137,1813){\rjust{$a=3$}}
\put(3137,1913){\rjust{$a=2$}}
\put(3137,2013){\rjust{$a=1$}}
\put(2000,2276){\cjust{Weibull Distribution}}
...
\put(2775,300){\cjust{1.5}}
\put(2000,300){\cjust{1}}
\put(1225,300){\cjust{0.5}}
\put(450,300){\cjust{0}}
\put(400,2126){\rjust{1.5}}
\put(400,1551){\rjust{1}}
\put(400,975){\rjust{0.5}}
\put(400,400){\rjust{0}}
\endGNUPLOTpicture
