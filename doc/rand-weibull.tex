...
\put(3087,1863){\rjust{$a=2,b=3$}}
\put(3087,1963){\rjust{$a=1,b=2$}}
\put(3087,2063){\rjust{$a=1,b=1$}}
\put(1925,2276){\cjust{Weibull Distribution}}
...
\put(350,200){\cjust{0}}
\put(300,2176){\rjust{1.5}}
\put(300,1551){\rjust{1}}
\put(300,925){\rjust{0.5}}
\put(300,300){\rjust{0}}
\endGNUPLOTpicture
