...
test_poly(void)
{
  ...
  n = gsl_poly_solve_quadratic (4.0, 7.0, 0.0, x);
  ...
  n = gsl_poly_solve_quadratic (5.0, 0.0, -20.0, x);
  ...
  n = gsl_poly_solve_cubic (-57.0, 1071.0, -6647.0, y);
  ...
  n = gsl_poly_solve_cubic (-143.0, 5087.0, -50065.0, y);
  ...
  n = gsl_poly_complex_solve_quadratic (4.0, -20.0, 26.0, z) ;
  ...
  n = gsl_poly_complex_solve_quadratic (4.0, -20.0, 25.0, z) ;
  ...
  n = gsl_poly_complex_solve_quadratic (4.0, -20.0, 21.0, z);
  ...
  n = gsl_poly_complex_solve_quadratic (4.0, 7.0, 0.0, z);
  ...
  n = gsl_poly_complex_solve_quadratic (5.0, 0.0, -20.0, z);
  ...
  n = gsl_poly_complex_solve_cubic (0.0, 0.0, -27.0, Z) ;
  ...
  n = gsl_poly_complex_solve_cubic (-51.0, 867.0, -4913.0, Z);
  ...
  n = gsl_poly_complex_solve_cubic (-57.0, 1071.0, -6647.0, Z);
  ...
  n = gsl_poly_complex_solve_cubic (-143.0, 5087.0, -50065.0, Z);
