...
double gsl_stats_ushort_pvariance (const unsigned short data1[], const unsigned short data2[], size_t stride1, size_t n1, const size_t stride2, size_t n2);
double gsl_stats_ushort_ttest (const unsigned short data1[], const unsigned short data2[], size_t stride1, size_t n1, size_t stride2, size_t n2);
...
void gsl_stats_ushort_sort_data (unsigned short data[], size_t stride, size_t n) ;
