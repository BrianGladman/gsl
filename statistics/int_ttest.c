		 ...
		 unsigned int n1, unsigned int n2)
{
  ...
  mean1 = gsl_stats_int_mean (data1, n1);
  mean2 = gsl_stats_int_mean (data2, n2);
  sd1 = gsl_stats_int_est_sd (data1, n1);
  sd2 = gsl_stats_int_est_sd (data2, n2);
  pv = gsl_stats_int_pvariance (data1, data2, n1, n2);
