...
double gsl_stats_pvariance (const double data1[], const double data2[], size_t stride1, size_t n1, const size_t stride2, size_t n2);
double gsl_stats_ttest (const double data1[], const double data2[], size_t stride1, size_t n1, size_t stride2, size_t n2);
...
void gsl_stats_sort_data (double data[], size_t stride, size_t n) ;
