...
double gsl_stats_int_pvariance (const int data1[], const int data2[], size_t stride1, size_t n1, const size_t stride2, size_t n2);
double gsl_stats_int_ttest (const int data1[], const int data2[], size_t stride1, size_t n1, size_t stride2, size_t n2);
...
void gsl_stats_int_sort_data (int data[], size_t stride, size_t n) ;
