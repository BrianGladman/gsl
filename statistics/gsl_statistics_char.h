...
double gsl_stats_char_pvariance (const char data1[], const char data2[], size_t stride1, size_t n1, const size_t stride2, size_t n2);
double gsl_stats_char_ttest (const char data1[], const char data2[], size_t stride1, size_t n1, size_t stride2, size_t n2);
...
void gsl_stats_char_sort_data (char data[], size_t stride, size_t n) ;
