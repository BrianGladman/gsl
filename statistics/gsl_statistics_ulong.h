...
double gsl_stats_ulong_pvariance (const unsigned long data1[], const unsigned long data2[], size_t stride1, size_t n1, const size_t stride2, size_t n2);
double gsl_stats_ulong_ttest (const unsigned long data1[], const unsigned long data2[], size_t stride1, size_t n1, size_t stride2, size_t n2);
...
void gsl_stats_ulong_sort_data (unsigned long data[], size_t stride, size_t n) ;
