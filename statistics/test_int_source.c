...
FUNCTION (test, func) (void)
{
  ...
  {
    double zeroth = FUNCTION(gsl_stats,percentile_from_sorted_data)(sorted, ina, 0.0) ;
    double expected = 8;
  ...
  {
    double top = FUNCTION(gsl_stats,percentile_from_sorted_data)(sorted, ina, 1.0) ;
    double expected = 22;
  ...
  {
    double median = FUNCTION(gsl_stats,percentile_from_sorted_data)(sorted, ina, 0.5) ;
    double expected = 18;
    gsl_test_rel (median,expected, rel,
		  NAME(gsl_stats) "_percentile_from_sorted_data (50, even)");
  }

  {
    double median = FUNCTION(gsl_stats,percentile_from_sorted_data)(sorted, ina - 1, 0.5);
    double expected = 18;
    gsl_test_rel (median,expected, rel,
		  NAME(gsl_stats) "_percentile_from_sorted_data (50, odd)");
  }
