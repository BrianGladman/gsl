...
const double flteps = 1e-4, dbleps = 1e-6;
  {
   float d1 = -1630.28519312;
   float d2 = 44320.1964703;
   float b1 = 1274.7681352;
   float b2 = 0.983006912864;
   float h[] = { -999, -999.1, -999.2, -999.3, -999.4 };
   float d1_expected = 0;
   float d2_expected = 0;
   float b1_expected = 0;
   float h0_expected = -1;
   float h11_expected = 0;
   float h21_expected = 0;
   float h12_expected = 0;
   float h22_expected = 0;
  ...
  {
   float d1 = 0.00100326116366;
   float d2 = -1.20359225232;
   float b1 = -7.45489498808;
   float b2 = 0.159616854019;
   float h[] = { -999, -999.1, -999.2, -999.3, -999.4 };
   float d1_expected = 0.00222932574734;
   float d2_expected = -2.67447728926;
   float b1_expected = -3.35491869218;
   float h0_expected = 0;
   float h11_expected = -999.1;
   float h21_expected = 0.0214110130692;
   float h12_expected = 25.6863620142;
  ...
  {
   float d1 = 0.00760694276009;
   float d2 = -1.07649167228;
   float b1 = -22584.0076391;
   float b2 = -0.00305597817159;
   float h[] = { -999, -999.1, -999.2, -999.3, -999.4 };
   float d1_expected = 0.00760694276011;
   float d2_expected = -1.07649167228;
   float b1_expected = -22584.007639;
   float h0_expected = 0;
   float h11_expected = -999.1;
   float h21_expected = -1.35316026298e-07;
   float h12_expected = -1.91491615001e-05;
   float h22_expected = -999.4;
   cblas_srotmg(&d1, &d2, &b1, b2, h);
