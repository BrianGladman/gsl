  ...
  for (i = 0; i < thurber_N; i++)
    {
      ...
      double n = b[0] + b[1]*xi + b[2]*xi*xi + b[3]*xi*xi*xi;
      double d = 1.0 + b[4]*xi + b[5]*xi*xi + b[6]*xi*xi*xi;
      double d_sq = d * d;
      double yi = n / d;
...
static gsl_multilarge_function_fdf thurber_func =
{
  &thurber_fdf,
  thurber_P,
  NULL,
