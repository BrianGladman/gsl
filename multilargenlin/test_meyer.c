...
static int
meyer_fdf (const int evaldf, const gsl_vector * x, void *params, void * work)
{
  int status;
  gsl_matrix_view J = gsl_matrix_view_array(meyer_J, meyer_N, meyer_P);
  gsl_vector_view f = gsl_vector_view_array(meyer_f, meyer_N);
...
static gsl_multilarge_function_fdf meyer_func =
{
  &meyer_fdf,
  meyer_P,
  NULL,
