...
typedef struct 
{
  ...
  int  (*errlevel) (void * state, const double y, const double dydt, const double h, const size_t ind, double * errlev);
...
typedef struct 
{
  ...
  int  (*apply)  (void * state, size_t dim, double t, double h, double y[], double yerr[], const double dydt_in[], double dydt_out[], const gsl_odeiv2_system * dydt);
  int  (*set_control) (void * state, gsl_odeiv2_control * c);
...
GSL_VAR const gsl_odeiv2_step_type *gsl_odeiv2_step_rk2simp;
GSL_VAR const gsl_odeiv2_step_type *gsl_odeiv2_step_rk4imp;
GSL_VAR const gsl_odeiv2_step_type *gsl_odeiv2_step_bsimp;
GSL_VAR const gsl_odeiv2_step_type *gsl_odeiv2_step_gear1;
GSL_VAR const gsl_odeiv2_step_type *gsl_odeiv2_step_gear2;
GSL_VAR const gsl_odeiv2_step_type *gsl_odeiv2_step_imprk2;
GSL_VAR const gsl_odeiv2_step_type *gsl_odeiv2_step_imprk4;
GSL_VAR const gsl_odeiv2_step_type *gsl_odeiv2_step_impeuler;
...
int  gsl_odeiv2_step_set_control (gsl_odeiv2_step *, gsl_odeiv2_control * c);
...
/* Driver object. This is a high level wrapper for step, control and
 * evolve objects. 
 */
...
typedef struct
{
  ...
  unsigned int n; /* number of steps taken */
  unsigned int nmax; /* Maximum number of steps allowed */
}
gsl_odeiv2_driver;

/* Driver object methods. 
 */
gsl_odeiv2_driver * gsl_odeiv2_driver_alloc_y_new (gsl_odeiv2_system *sys, const gsl_odeiv2_step_type *T, const double hstart, const double epsabs, const double epsrel);
...
int gsl_odeiv2_driver_set_nmax (gsl_odeiv2_driver * D, const size_t nmax);
gsl_odeiv2_driver * gsl_odeiv2_driver_alloc_scaled_new (gsl_odeiv2_system *sys, const gsl_odeiv2_step_type *T, const double hstart, const double epsabs, const double epsrel, const double a_y, const double a_dydt, const double scale_abs[]);
